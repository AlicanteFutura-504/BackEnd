    ...
    for (let i = 1; i <= NUM_CUSTOMERS; i++) {
      ...
      if (queryValues.length >= CHUNK_SIZE || i === NUM_CUSTOMERS) {
        ...
        res.rows.forEach((r, idx) => {
          ...
          // La asignación de bias debe coincidir con el index del chunk. Como generamos el chunk secuencialmente, i - queryValues.length + idx es el índice original.
          // Pero para simplificar, i-esimo en general es:
